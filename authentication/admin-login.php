...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username === '' || $password === '') {
        ...
        $allowed_admin_roles = ['admin', 'administrator'];
        $db_role = strtolower((string) ($user['role'] ?? ''));

        if ($user && in_array($db_role, $allowed_admin_roles, true) && password_verify($password, $user['password'])) {
...
<head>
    ...
    <title>Administration Login - EngineeTrack</title>
