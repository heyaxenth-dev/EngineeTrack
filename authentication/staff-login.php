...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($username === '' || $password === '') {
    ...
    $non_staff_roles = ['admin', 'administrator'];
    $db_role = strtolower((string) ($user['role'] ?? ''));

    if ($user && !in_array($db_role, $non_staff_roles, true) && password_verify($password, $user['password'])) {
...
<head>
    ...
    <title>Staff Login - EngineeTrack</title>
