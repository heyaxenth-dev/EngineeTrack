...
<head>
    ...
    <title>Index - EngineeTrack</title>
        ...
        <div class="branding d-flex align-items-cente">
            ...
            <div class="container position-relative d-flex align-items-center justify-content-between">
                <a href="index.html" class="logo d-flex align-items-center">
                    ...
                    <h1 class="sitename">EngineeTrack</h1>
                </a>

                <nav id="navmenu" class="navmenu">
                    <ul>
                        <li><a href="#hero" class="active">Home</a></li>
                        <li><a href="authentication/admin-login.php">Administration</a></li>
                        <li><a href="authentication/staff-login.php">Staff</a></li>
                    </ul>
            ...
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center"
                        data-aos="zoom-out">
                        <h1>Welcome to <span>EngineeTrack</span></h1>
